                ...
                <div class="row">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-footer">
							...
							<!-- <a href='deletehome.php?did=".$id."' class='btn btn-danger'>Not Confirm</a> -->
						...
						{	
							...
							if($st=="Confirm")
							{
								...
								if($f1=="NO" )
								{
									...
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Non AC Room')</script>";
									...
									{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														$ttot = ($type_of_room + $type_of_bed) * $days * $nroom ;
														$mepr = 0;
														$btot = 0;
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`,`roomno`) VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days','$roomno')";
